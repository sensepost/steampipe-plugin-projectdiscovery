...
func tableProjectdiscoveryTlsx() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "client", Type: proto.ColumnType_STRING, Transform: transform.FromField("tls_connection"), Description: `The TLS client used`},
			{Name: "success", Type: proto.ColumnType_BOOL, Transform: transform.FromField("probe_status"), Description: `False if the probe failed`},
